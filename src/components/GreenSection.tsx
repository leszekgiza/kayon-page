      ...
      <div className="container-custom">
        <div className="grid lg:grid-cols-[1fr,2fr] gap-12 lg:gap-16 items-start">
          ...
          <div className="mb-8 lg:mb-0">
            ...
            {/* Title */}
            <h2 className="text-2xl md:text-3xl lg:text-[40px] leading-[1.2] font-bold text-primary">
              ...
              <ul className="space-y-2 md:space-y-3">
                {[
                  ...
                  <li key={index} className="flex items-start gap-2 md:gap-3">
                    <svg className="w-4 h-4 md:w-5 md:h-5 text-accent-green flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">

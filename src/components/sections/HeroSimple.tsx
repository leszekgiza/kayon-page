...
const HeroSimple = ({ title, desc }: { title: string, desc: string }) => {
  return (
    <section className="relative overflow-hidden bg-[#343432] text-white">
      ...
      <div className="px-4 py-10 pt-32 md:pt-32 lg:px-10 xl:px-20 2xl:px-0 max-w-[1440px] mx-auto flex flex-col lg:flex-row justify-between items-center lg:gap-4">
        <div className="lg:w-1/2">
          <KayonLogo className="h-[40px] w-auto md:h-[60px] lg:h-[76px]" />
        </div>

        <div className="max-lg:order-last mx-2 xl:mx-24 lg:h-full flex flex-col justify-end">

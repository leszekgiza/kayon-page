  ...
  return (
    <section id="nasi-klienci" className="bg-gradient-to-r from-[#53923e] via-[#53923e] to-[#77bb61] text-white">
      <div id='green-section-cols' className="px-0 max-w-[1400px] mx-auto 2xl:flex flex-col 2xl:flex-row items-center">
        <div id='green-section-left-col' className="xl:px-20 2xl:px-0 py-8 pe-8 md:py-24 2xl:min-h-[800px] md:min-w-[50%] flex flex-col justify-between gap-8 bg-[#53923e]">
        ...
        <div id='green-section-right-col' className="ps-8 md:ps-16 2xl:ps-10 py-8 md:py-24 2xl:min-h-[800px] relative w-full 2xl:w-[50vw] flex flex-col justify-between gap-8 bg-[#77bb61]">

...
const OfferSection = () => {
  ...
  return (
    <section id="oferta" className="bg-[#2cbceb] text-white">
      <div className="mx-auto px-8 py-12 md:py-24 max-w-[1660px] lg:min-h-[800px] flex flex-col 2xl:flex-row justify-between gap-8 2xl:gap-28">
        <div className="max-w-[600px] flex flex-col gap-8 md:gap-y-8 2xl:gap-y-16 text-primary">
        ...
        >
          {offer.cards.map((card) => (
            <div key={card.title} className="px-6 py-8 md:w-1/2 2xl:w-[410px] md:min-h-[750px] flex h-full flex-col gap-4 rounded-[32px] bg-white text-primary shadow-lg">

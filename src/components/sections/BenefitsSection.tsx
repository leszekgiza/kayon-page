  ...
  return (
    <>
      <section id="jak-dzialamy" className="bg-[#f4b250] text-primary">
        <div className="lg:px-10 xl:px-20 2xl:px-0 py-12 md:py-24 max-w-[1400px] mx-auto lg:min-h-[800px] flex flex-col 2xl:flex-row justify-between gap-8 2xl:gap-28">
